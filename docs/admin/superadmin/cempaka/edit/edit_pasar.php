<?php
  ...
  if (isset($_GET['id'])) {
    ...
    $id = ($_GET["id"]);
    $query = "SELECT * FROM cempaka_spot_pasar WHERE id='$id'";
...
<body>
    <div class="container">
        <h2>Edit Info Pasar</h2>
        <form method="POST" action="../save/save_pasar.php" enctype="multipart/form-data">
            ...
            <div>
                ...
                <img src="../../../cempaka/images/<?php echo $data['foto']; ?>"
                    style="width: 200px;float: left;margin-bottom: 5px;">
