<?php
  ...
  if (isset($_GET['id'])) {
    ...
    $id = ($_GET["id"]);
    $query = "SELECT * FROM guci_spot_geong WHERE id='$id'";
    ...
    $data = mysqli_fetch_assoc($result);
       if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='../../info_geong.php';</script>";
       }
  } else {
    echo "<script>alert('Masukkan data id.');window.location='../../info_geong.php';</script>";
  }         
  ?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="container">
        <h2>Edit Info</h2>
        <form method="POST" action="../save_info/save_info_geong.php" enctype="multipart/form-data">
