<?php
  ...
  if (isset($_GET['id'])) {
    ...
    $id = ($_GET["id"]);
    $query = "SELECT * FROM sawahbatu_spot_kolamrenang WHERE id='$id'";
    ...
    $data = mysqli_fetch_assoc($result);
       if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='../../info_kolam_renang.php';</script>";
       }
  } else {
    echo "<script>alert('Masukkan data id.');window.location='../../info_kolam_renang.php';</script>";
  }         
  ?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="container">
        <h2>Edit Info</h2>
        <form method="POST" action="../save_info/save_info_kolam_renang.php" enctype="multipart/form-data">
            ...
            <div>
                ...
                <a href="../../info_kolam_renang.php"></a>
