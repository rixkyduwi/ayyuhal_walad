<?php
  ...
  if (isset($_GET['id'])) {
    ...
    $id = ($_GET["id"]);
    $query = "SELECT * FROM sawahbatu_spot_gerbang WHERE id='$id'";
    ...
    $data = mysqli_fetch_assoc($result);
       if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='../../info_pancuran5.php';</script>";
       }
  } else {
    echo "<script>alert('Masukkan data id.');window.location='../../info_pancuran5.php';</script>";
  }         
  ?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="container">
        <h2>Edit Info</h2>
        <form method="POST" action="../save_info/save_info_pancuran5.php" enctype="multipart/form-data">
